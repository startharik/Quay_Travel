...
import { h as saveProfile, o as getMyProfile, r as t, v as Button, y as cn } from "./router-AcUgDc4y.mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/onboarding-CyXe4WqC.js
...
function Onboarding() {
	...
	if (!ready) return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(PageLoading, { className: "h-40" });
